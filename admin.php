...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">UET FAQ</a>
...
if(@$_GET['p']==2){
    ...
    $sql = "SELECT * FROM information WHERE answers = 'Per momentin nuk kam informacion, por se shpejti do iu pergjigjem.'";
...
if(@$_GET['p']==3){
  ...
  echo'<form action="admin.php?p=4" method="POST">
           ...
           <input type="text" name="question"  class="form-control" placeholder="Pyetja">
            <label></label>
            <textarea name="answer" rows="5" cols="30" class="form-control" placeholder="Pergjigjia"></textarea>
            <br>
...
if (!empty($question)||!empty($answer)){
      ...
      header("location: admin.php?p=1");
        ...
        echo "Ju lutem jepni te gjitha te dhenat e nevojshme!!!";
        die();
      }
}
